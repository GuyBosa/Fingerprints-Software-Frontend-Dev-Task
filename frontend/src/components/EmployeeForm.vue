<template>
  <div id="employee-form">
    <form @submit.prevent="handleSubmit">
      ...
      <div class="form-group">
        <label for="TodoTask">Employee Task</label>
        <input
          v-model="employee.TodoTask"
          @focus="clearStatus"
          type="text"
          name="TodoTask"
          id="TodoTask"
          class="form-control"
          placeholder="Task"
          aria-describedby="TodoTask"
        />
        <small id="TodoTask" class="text-muted">The task of the employee</small>
      </div>
